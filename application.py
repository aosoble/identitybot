...
async def on_message(message):
    if message.content.startswith('!id '):
        ...
        if command.startswith('iam '):
            ...
            "`!id iam [introduction]`: This command will save your whatever you " 
            "set as [introduction] with the bot. Your introduction can be "
            "as long as you want. Other users can get your introduction "
            "using the command below.\n\n"
            "`!id whois @user1 @user2`: This command will get introductions "
            "for the users you mention in the message and DM them to you. " 
            "Note that it sends a DM and does not reply on the same "
            "channel.\n\n"
            "`!id list`: This command lists all users who have saved " 
            "introductions with Identity Bot on your server.\n\n"
            "`!id delete`: This command will delete your introduction. Other " 
            "users won't be able to get your introduction any more after " 
            "using this command.\n\n"
            "`!id help`: Displays this help message."
            ))
